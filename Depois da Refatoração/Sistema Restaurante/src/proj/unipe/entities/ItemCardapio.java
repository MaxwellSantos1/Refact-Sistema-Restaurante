...
public class ItemCardapio extends AbstractEntity {
	...
	public Tradicional getTradicional() {
		if(pedido instanceof Tradicional)
	...
	public void itemCardapio(CardapioService cardapioService) {
		Cardapio cardapio = cardapioService.buscarPorId(getCardapio().getId());
		setCardapio(cardapio);
		setPreco(cardapio.getPreco());
	}
